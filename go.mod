...
require (
	...
	github.com/bsv-blockchain/go-chaincfg v1.5.0 // indirect
	...
	github.com/bsv-blockchain/go-subtree v1.1.1 // indirect
	github.com/bsv-blockchain/go-tx-map v1.2.0 // indirect
	github.com/bsv-blockchain/go-wire v1.1.0 // indirect
