...
require (
	...
	k8s.io/klog/v2 v2.1301 // indirect
...
replace github.com/libsv/go-bt/v2 => github.com/bsv-blockchain/go-bt/v2 v2.5.2

// Security fix: CVE-2025-31133, CVE-2025-52565 - upgrade runc to patched version
replace github.com/opencontainers/runc v1.1.5 => github.com/opencontainers/runc v1.4.0

// Security fix: CVE-2024-25621 - upgrade containerd to latest patched version
replace github.com/containerd/containerd/v2 v2.1.4 => github.com/containerd/containerd/v2 v2.2.1
