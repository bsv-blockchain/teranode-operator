...
var _ = Describe("Asset Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			By("creating the custom resource for the Kind Asset")
			err := k8sClient.Get(ctx, typeNamespacedName, asset)
		...
		It("should successfully reconcile the resource", func() {
			...
			controllerReconciler := &AssetReconciler{
				Client: k8sClient,
