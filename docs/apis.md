...
Each of these APIs share a common set of configuration values that can be set directly on their spec (with the exception of [Cluster](./cluster.md)). These configuration values allow the user to customize the deployment of each service to suit their needs.

## Configuration
| Key               | Type                          | Description                                                          |
|-------------------|-------------------------------|----------------------------------------------------------------------|
| `nodeSelector`    | `map[string]string`           | Cluster Selector field for deployment                                   |
